...
const pdfTopics: PDFTopic[] = [
   {
    ...
    topic: "Computer Knowledge(ICT)-CH1:Architecture of Computer (No.of Questions 78)- Available @ Just Rs. 8/-",
    price: "₹8",
  ...
  },
  {
    code: "CS-ICT-02",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH2:Input & Output Devices (No.of Questions 85)- Available @ Just Rs. 8/-",
    price: "₹8",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
    {
    code: "CS-ICT-03",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH3:Storage Devices (No.of Questions 102)- Available @ Just Rs. 8/-",
    price: "₹8",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-04",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH4:Networking (No.of Questions 100)- Available @ Just Rs. 8/-",
    price: "₹8",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-05",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH5:Operating System (No.of Questions 200)- Available @ Just Rs. 10/-",
    price: "₹10",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-06",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH6:Microsoft Office (No.of Questions 250)- Available @ Just Rs. 10/-",
    price: "₹10",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-07",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH7:Internet and E-Mail (No.of Questions 120)- Available @ Just Rs. 10/-",
    price: "₹10",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-08",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH8:Website & Web Browswers (No.of Questions 150)- Available @ Just Rs. 10/-",
    price: "₹10",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {
    code: "CS-ICT-09",
    subject: "Computer Knowledge(ICT)",
    topic: "Computer Knowledge(ICT)-CH9:Computer Virus (No.of Questions 100)- Available @ Just Rs. 8/-",
    price: "₹8",
    formUrl: "https://forms.gle/9Dd8jpEuDwGZsvWL8",
  },
  {/*
